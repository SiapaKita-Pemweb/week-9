            ...
            <table border="1">
                ...
                <?php
                    ...
                    while($data = mysqli_fetch_assoc($result)){
                        ...
                        echo "<td> $data[gpa] </td>";
                        echo "<td><a href='update.php?nim=$data[nim]'>EDIT</a></td>";
                        echo "<td><a onClick=\"return confirm('Anda yakin ingin menghapus ini?')\" href=\"delete_process.php?nim=$data[nim]\">HAPUS</a></td>";
                        echo "</tr>";
                    }
