<?php
    ...
    $query = "CREATE TABLE student (nim CHAR(8), name VARCHAR(100), birth_city VARCHAR(50), birth_date DATE, faculty VARCHAR(50), department VARCHAR(50), gpa DECIMAL(3,2), PRIMARY KEY (nim))";
    $query_result = mysqli_query($connection, $query);
    if(!$query_result){
        die ("Query Error: ".mysqli_errno($connection)." - ".mysqli_error($connection));
    }
    ...
    // Insert data student
    $query = "INSERT INTO student VALUES ('12041952', 'Brian Yuko', 'Padang', '1996-11-23', 'FTIB', 'Sistem Informasi', 3.1), ('12042010', 'Safira Yanuar', 'Bandung', '1994-08-22', 'FTIB', 'Sistem Informasi', 3.9), ('12042012', 'Rezja Zalva', 'Jakarta', '1997-12-31', 'FTIB', 'Informatika', 3.5), ('12042034', 'Agha Rizky', 'Jakarta', '1997-06-28', 'FTEIC', 'Sains Data', 3.4), ('12042041', 'Adhiaksa', 'Medan', '1995-04-02', 'FTEIC','Bisnis Digital', 3.7)";
    $query_result = mysqli_query($connection, $query);
    if(!$query_result){
        die ("Query Error: ".mysqli_errno($connection)." - ".mysqli_error($connection));
    }
